...
import { PresetKeys } from '../../interface'
  ...
  return (
    <main className="h-full flex flex-col bg-lime-500">
      <div className="w-[1200px] my-3 mx-auto flex items-center">
        ...
        <select
          className="rounded-md text-gray-500 h-14 min-w-[256px] w-full px-4 appearance-none focus-visible:outline-none"
      ...
      <div className="flex justify-center items-center my-3 mx-auto">
        <Link
          to="/a"
          className="text-2xl text-white rounded-md font-medium decoration-0 py-3 px-6 hover:bg-[rgba(47,66,80,0.2)]"
        >
          to A
        </Link>
        <Link
